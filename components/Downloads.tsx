...
const documents = [
  {
    ...
    description:
      "Initial topic assessment document outlining the research area and preliminary scope.",
    type: "document",
    date: "August 2024",
    ...
    status: "available",
    category: "Group",
    downloadUrl: "/documents/topic-assessment.pdf",
  },

  {
    title: "Project Proposal",
    description:
      "Detailed project proposal outlining Lexayudha objectives, methodology, and expected outcomes.",
    type: "document",
    date: "August 2024",
  ...
  },
  {
    ...
    description:
      "Academic research paper on intelligent environmental monitoring systems and their applications.",
    type: "document",
    date: "February 2025",
  ...
  },
  {
    title: "Final Report",
    description:
      "Complete individual project report documenting development process, results, and conclusions.",
    type: "document",
    date: "May 2025",
...
const presentations = [
  {
    title: "Project Proposal",
    description:
      "Initial project presentation outlining Lexayudha concept and development plan.",
    type: "presentation",
    date: "August 2024",
    ...
    status: "available",
    category: "Group",
    downloadUrl: "/presentations/project-proposal.pdf",
  },
  {
    title: "Progress Presentation I",
    description:
      "Mid-project presentation showcasing development progress and initial results.",
    type: "presentation",
    date: "December 2024",
    ...
    status: "available",
    category: "Group",
    downloadUrl: "/presentations/progress-presentation-1.pdf",
  },
  {
    title: "Progress Presentation II",
    description:
      "Advanced progress presentation demonstrating system functionality and testing results.",
    type: "presentation",
    date: "March 2025",
    ...
    status: "available",
    category: "Group",
    downloadUrl: "/presentations/progress-presentation-2.pdf",
  },
  {
    title: "Final Presentation",
    description:
      "Comprehensive final presentation covering complete Lexayudha implementation and evaluation.",
    type: "presentation",
    date: "May 2025",
        ...
        >
          ...
          <div className="mb-16">
            ...
            <p className="text-gray-300 mb-8 text-center">
              Access all project documents including assessments, proposals,
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <span
                        className={`px-2 py-1 text-xs rounded-full border ${getCategoryBadge(
                          doc.category
                        )}`}
                      >
                        {doc.category}
                    ...
                    {doc.status === "available" ? (
                      <>
                        <motion.button
                          ...
                          onClick={() => {
                            if (doc.downloadUrl.includes("drive.google.com")) {
                              ...
                              link.download =
                                doc.title + "." + doc.format.toLowerCase();
                        ...
                        >
                          ...
                          {doc.downloadUrl.includes("drive.google.com")
                            ? "Open Drive"
                            : "Download"}
                        </motion.button>
                        <motion.button
                        ...
                        <motion.button
                          ...
                          onClick={() => {
                            ...
                            link.download =
                              presentation.title +
                              "." +
                              presentation.format.toLowerCase();
                            document.body.appendChild(link);
                            link.click();
                            document.body.removeChild(link);
                          }}
          ...
          <div className="mt-12 bg-blue-500/10 p-6 rounded-lg border border-blue-500/20">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              All documents and presentations are provided for educational and
              research purposes. Please ensure you have the necessary
              permissions before downloading and using these materials. For any
              questions or additional resources, please contact our team.
            </p>
          </div>
        </motion.div>
      </div>
