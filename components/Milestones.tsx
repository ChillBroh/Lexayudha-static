...
const milestones = [
  {
    ...
    date: "August 23, 2024",
    description:
      "Initial project proposal submission outlining the Lexayudha concept, objectives, and implementation plan.",
    status: "completed",
    deliverables: [
      "Project Charter",
      "Research Objectives",
  ...
  },
  {
    ...
    description:
      "First progress presentation showcasing initial development, literature review, and preliminary results.",
    status: "completed",
    deliverables: [
      "Literature Survey",
      "System Architecture",
  ...
  },
  {
    ...
    date: "February 2025",
    description:
      "Academic research paper documenting the Lexayudha methodology, implementation, and findings.",
    status: "completed",
    deliverables: [
  ...
  },
  {
    ...
    date: "March 2025",
    description:
      "Second progress presentation demonstrating advanced features, testing results, and system integration.",
    status: "completed",
  ...
  },
  {
    ...
    date: "April 2025",
    description:
      "Comprehensive assessment of the Lexayudha web platform, user interface, and functionality.",
    status: "completed",
    deliverables: [
  ...
  },
  {
    ...
    date: "April 2025",
    description:
      "Complete project logbook documenting the development process, challenges, and solutions.",
    status: "completed",
    deliverables: [
      "Development Log",
      "Technical Decisions",
  ...
  },
  {
    ...
    date: "May 2025",
    description:
      "Comprehensive final report covering all aspects of the Lexayudha project from conception to completion.",
    status: "completed",
    deliverables: [
      "Final Report",
  ...
  },
  {
    ...
    date: "May 27, 2025",
    description:
      "Final project presentation and viva voce examination demonstrating the complete Lexayudha solution.",
    status: "completed",
    deliverables: [
      "Final Presentation",
          ...
          <div className="mb-12">
            ...
            <div className="bg-white/5 p-6 sm:p-8 rounded-lg border border-white/10">
              <p className="text-gray-300 text-lg leading-relaxed text-center mb-6">
                Lexayudha project follows a structured academic timeline
                spanning from August 2024 to May 2025, with key milestones
                aligned to university assessment requirements and research
                deliverables.
              </p>
                    ...
                    <div className="ml-8 flex-1">
                      <div className="bg-white/5 p-6 rounded-lg border border-white/10 relative">
                        ...
                        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
                          ...
                          <span
                            className={`px-3 py-1 text-xs rounded-full border font-medium ${getStatusColor(
                              milestone.status
                            )} self-start`}
                          >
                            {milestone.status === "completed"
